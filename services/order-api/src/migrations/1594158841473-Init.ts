...
export class Init1594158841473 implements MigrationInterface {
    name = 'Init1594158841473'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "orders"."order" ("orderid" SERIAL NOT NULL, "userid" character varying NOT NULL, "created_ts" TIMESTAMP NOT NULL DEFAULT now(), "updated_ts" TIMESTAMP NOT NULL DEFAULT now(), "firstname" character varying NOT NULL, "lastname" character varying NOT NULL, "streetaddress" character varying NOT NULL, "postalcode" character varying NOT NULL, "email" character varying NOT NULL, "phonenumber" character varying NOT NULL, CONSTRAINT "PK_b45899ee611fd0e46277114cb88" PRIMARY KEY ("orderid"))`);
